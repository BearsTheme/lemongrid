...
class lemongrid_widget extends WP_Widget 
{
	public function __construct() {
		...
		parent::__construct( 'lemongrid_widget', __( 'Lemon Grid', TB_NAME ), array(
				'classname'   => 'lemongrid_widget',
				'description' => __( 'A grid use for Post, Gallery, Social (Instagram, Flickr)', TB_NAME ),
				) );
	}
	...
	function form( $instance ) {
		...
		$types = array( 
			'social' => __( 'Social', TB_NAME ),
			// 'post' => __( 'Post', TB_NAME ),
			'gallery' => __( 'Gallery', TB_NAME ) );

		$socials = array(
			'instagram' => __( 'Instagram', TB_NAME ),
			'flickr' => __( 'Flickr', TB_NAME ) );
		...
		<!-- wg_id -->
		<p>
			<label for="<?php esc_attr_e( $this->get_field_id( 'wg_id' ) ); ?>"><?php _e( 'Widget ID:', TB_NAME ); ?></label>
		...
		<!-- title -->
		<p>
			<label for="<?php esc_attr_e( $this->get_field_id( 'title' ) ); ?>"><?php _e( 'Title:', TB_NAME ); ?></label>
		...
		<!-- Type -->
		<p>
			<label for="<?php esc_attr_e( $this->get_field_id( 'type' ) ); ?>"><?php _e( 'Type:', TB_NAME ); ?></label>
		...
		<?php foreach( $types as $type_name => $type_text ) :
			...
			switch( $type_name ) {
				...
				case 'post' :
					...
					echo sprintf( '<p>%s</p>', __( 'Coming soon...!', TB_NAME ) );
					break;
		...
		<!-- Cell height -->
		<p>
			<label for="<?php esc_attr_e( $this->get_field_id( 'cell_height' ) ); ?>"><?php _e( 'Cell Height:', TB_NAME ); ?></label>
		...
		<!-- Space -->
		<p>
			<label for="<?php esc_attr_e( $this->get_field_id( 'space' ) ); ?>"><?php _e( 'Space:', TB_NAME ); ?></label>
		...
		<!-- Template -->
		<p>
			<label for="<?php esc_attr_e( $this->get_field_id( 'template' ) ); ?>"><?php _e( 'Template:', TB_NAME ); ?></label>
		...
		<!-- Extra class -->
		<p>
			<label for="<?php esc_attr_e( $this->get_field_id( 'extra_class' ) ); ?>"><?php _e( 'Extra Class:', TB_NAME ); ?></label>
